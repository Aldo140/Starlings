    ...
    >
      ...
      <div className="flex flex-wrap gap-2">
        {post.what_helped.map((tag, idx) => (
          <span 
            key={idx}
            className="px-3 py-1.5 rounded-full bg-[#f9fbfa] text-[#448a7d] text-[9px] font-black uppercase tracking-widest border border-gray-100 group-hover:border-teal-100 transition-colors"
          >
            {tag}
          </span>
        ))}
